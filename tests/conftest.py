...
@pytest.fixture
def strategy(StrategyBalancerBoostedPool, vault, trade_factory, ymechs_safe, keeper, strategist, gov, yearn_balancer_voter, voter_proxy, gauge):
    strategy = strategist.deploy(StrategyBalancerBoostedPool, vault, "BalancerBoostedAaveStrategy", voter_proxy, yearn_balancer_voter)
