...
def test_cloning(
    ...
    ## clone our strategy
    tx = strategy.cloneCurveETHLP(
        vault, strategist, rewards, keeper, gauge, pool, strategy_name, {"from": gov}
    )
    newStrategy = StrategyCurveETHLP.at(tx.return_value)
